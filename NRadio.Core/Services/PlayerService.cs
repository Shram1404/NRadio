...
namespace NRadio.Core.Services
{
    public static class PlayerService
    {
        ...
        static PlayerService()
        {
            ...
            _systemMediaControls.add_ButtonPressed(new TypedEventHandler<SystemMediaTransportControls, SystemMediaTransportControlsButtonPressedEventArgs>(SystemMediaControls_ButtonPressed));
